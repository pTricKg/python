...
w = 1
h = 4
print "Volume of rectangular prism",l,w,h,"is",volume_rect_prism(r),"." # volumerecprism was error


############
# Has a NameError
import random # didn't have import random causing error
def random_dice():
...
def volume_sphere(radius):
    return 4/3 * math.pi * (radius**3) # .Pi was error
...
# area_triangle was missing second param

############
# Has a SyntaxError
def identity(x): # error caused by missing colon
    return x
...
# Has a SyntaxError
def is_mary(x):
    if x = "Mary": # = isn't evaluator <==> or comparason
        print "Found Mary!"
    else:
        print "No Mary."
...
height=4
hyp=5
print "Area of triangle with sides",base,height,hyp,"is",area_triangle_sss(base
